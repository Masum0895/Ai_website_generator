  ...
  return (
    ...
    <nav className="z-50 flex items-center justify-between w-full py-4 px-4 md:px-16 lg:px-24 xl:px-32 backdrop-blur border-b text-white border-slate-800">
        ...
        <div className="hidden md:flex items-center gap-8 transition duration-500">
            ...
            <Link to='/projects' className="hover:text-indigo-400 transition">My Projects</Link>
            <Link to='/community' className="hover:text-indigo-400 transition">Community</Link>
        ...
        {menuOpen && (
          <div className="fixed inset-0 z-[100] bg-black/60 text-white backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300">
            <Link to='/' onClick={() => setMenuOpen(false)} className="hover:text-indigo-400 transition">Home</Link>
            <Link to='/projects' onClick={() => setMenuOpen(false)} className="hover:text-indigo-400 transition">My Projects</Link>
            <Link to='/community' onClick={() => setMenuOpen(false)} className="hover:text-indigo-400 transition">Community</Link>
            <Link to='/pricing' onClick={() => setMenuOpen(false)} className="hover:text-indigo-400 transition">Pricing</Link>
